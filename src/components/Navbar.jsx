...
const Navbar = () => {
  ...
  return (
    <div className="justify-start no-scrollbar bg-zinc-950 w-fit h-full fixed top-0 left-0 z-50 flex flex-col items-center overflow-hidden overflow-y-scroll pt-3.5">
